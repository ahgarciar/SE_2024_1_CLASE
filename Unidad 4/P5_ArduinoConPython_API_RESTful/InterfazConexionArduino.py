...
qtCreatorFile = "InterfazConexionArduino.ui"  # Nombre del archivo aquí.
...
class MyApp(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def resizeEvent(self, event):
        # Se ejecuta cada vez que la ventana cambia de tamaño.        
        self.setFixedSize(self.size())  # Establece el tamaño actual como el fijo        
